namespace Proyecto
{
    partial class formClientesModificar
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.pnHeader.WorkingArea.Controls.Add(this.btnModificar);
            this.pnHeader.WorkingArea.Controls.Add(this.pbIdentificacionNueva);
            this.pnHeader.WorkingArea.Controls.Add(this.pbArchivos);
            this.pnHeader.WorkingArea.Controls.Add(this.pbFlecha2);
            this.pnHeader.WorkingArea.Controls.Add(this.pbFlecha3);
            this.pnHeader.WorkingArea.Controls.Add(this.pbFlecha1);
            this.pnHeader.WorkingArea.Controls.Add(this.switchIdentificacion);
            this.pnHeader.WorkingArea.Controls.Add(this.lblAhora);
            this.pnHeader.WorkingArea.Controls.Add(this.lblCorreo);
            this.pnHeader.WorkingArea.Controls.Add(this.lblNombre);
            this.pnHeader.WorkingArea.Controls.Add(this.txtCorreoNuevo);
            this.pnHeader.WorkingArea.Controls.Add(this.txtCorreo);
            this.pnHeader.WorkingArea.Controls.Add(this.txtTelefonoNuevo);
            this.pnHeader.WorkingArea.Controls.Add(this.txtTelefono);
            this.pnHeader.WorkingArea.Controls.Add(this.txtNombreNuevo);
            this.pnHeader.WorkingArea.Controls.Add(this.lblAntes);
            this.pnHeader.WorkingArea.Controls.Add(this.lblTelefono);
            ...
            this.pnHeader.WorkingArea.PerformLayout();
